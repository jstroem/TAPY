...
case class BinOpNode(op: constants.BinOp,arg1_reg:Int,arg2_reg:Int,result_reg:Int) extends Node

// Unary operation: result = op arg1
case class UnaryOpNode(op: constants.UnOp,arg1_reg:Int,result_reg:Int) extends Node
